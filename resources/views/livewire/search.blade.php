<div>
    <form class="form-inline my-2 my-lg-0">
        <input wire:model.depounce.300ms="search" class="form-control mr-sm-2" type="search" placeholder="Search" aria-label="Search">
        ...
        <ul>
            ...
            @isset($tv_shows['results'])
                @foreach ($tv_shows['results'] as $tv)
                    <li>
                        <a href="{{route("movie.show",[$tv['id'],SlugIt($tv['name'])])}}">
